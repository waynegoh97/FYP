...
#     case_name = ['_train', '_wgan', '_original_wgan', '_mix']
#     floor_id = ['floor-1','floor1','floor2']
#     result_dir = "C:/Users/noxtu/LnF_FYP2122S1_Goh-Yun-Bo-Wayne/FYP_data/csv_dataset/NG/csv_files/results/ng_combined_result.csv"
#     df = pd.read_csv("C:/Users/noxtu/LnF_FYP2122S1_Goh-Yun-Bo-Wayne/FYP_data/csv_dataset/NG/csv_files/results/ng_results.csv", header=0)
#     
#     temp_id = []
#     temp_avg = []
#     for case in case_name:
...
#                 temp_df= df[(df['LR'] == l) & (df['TRAIN_COUNT'] == num) 
#                                      & (df['CASE'] == case)]
